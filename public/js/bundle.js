...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/main.scss */ \"./src/scss/main.scss\");\n/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_main_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _view_dom_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/dom-view */ \"./src/js/view/dom-view.js\");\n/* harmony import */ var _model_Search__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/Search */ \"./src/js/model/Search.js\");\n/* harmony import */ var _view_search_view__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/search-view */ \"./src/js/view/search-view.js\");\n/* harmony import */ var _model_Page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/Page */ \"./src/js/model/Page.js\");\n/* This is the base JS file which will be boundle to public folder */\r\n /* <- scss file */\r\n\r\n\r\n\r\n\r\n\r\nlet page = new _model_Page__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\r\n\r\nif (window.location.hash) {\r\n  let name = window.location.hash.substring(1);\r\n  if (name !== 'home' && name !== 'weather') {\r\n    page.name = 'home';\r\n    page.loadPage();\r\n  } else {\r\n    page.name = name;\r\n    page.loadPage();\r\n  }\r\n}\r\n\r\n_view_dom_view__WEBPACK_IMPORTED_MODULE_1__[\"default\"].home.addEventListener('click', function() {\r\n  page.name = 'home';\r\n  page.loadPage();\r\n  _view_dom_view__WEBPACK_IMPORTED_MODULE_1__[\"default\"].closeMenu();\r\n});\r\n\r\n_view_dom_view__WEBPACK_IMPORTED_MODULE_1__[\"default\"].currentLocationButton.addEventListener('click', function() {\r\n  page.name = 'weather';\r\n  page.loadPage();\r\n  navigator.geolocation.getCurrentPosition(async function(position) {\r\n    let lat = position.coords.latitude;\r\n    let long = position.coords.longitude;\r\n\r\n    let currentCity = [lat, long];\r\n    console.log(currentCity);\r\n\r\n    try {\r\n      let search = new _model_Search__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n      let result = await search.getWeatherByLatLong(currentCity);\r\n      console.log(result);\r\n    } catch (e) {\r\n      console.log(e);\r\n    }\r\n  });\r\n});\r\n\r\n_view_dom_view__WEBPACK_IMPORTED_MODULE_1__[\"default\"].searchButton.addEventListener('click', async function() {\r\n  page.name = 'weather';\r\n  page.loadPage();\r\n  try {\r\n    let cityName = _view_search_view__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getValueFromInput();\r\n    let citySearch = new _model_Search__WEBPACK_IMPORTED_MODULE_2__[\"default\"](cityName);\r\n    let result = await citySearch.getWeatherByCity();\r\n\r\n    console.log(result);\r\n    _view_search_view__WEBPACK_IMPORTED_MODULE_3__[\"default\"].clearInput();\r\n\r\n    _view_dom_view__WEBPACK_IMPORTED_MODULE_1__[\"default\"].removeErrorClass();\r\n    _view_dom_view__WEBPACK_IMPORTED_MODULE_1__[\"default\"].closeMenu();\r\n  } catch (e) {\r\n    _view_dom_view__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addErrorClass();\r\n    console.log(e);\r\n  }\r\n});\r\n\n\n//# sourceURL=webpack:///./src/js/index.js?");
